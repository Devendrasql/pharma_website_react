...
//         {/* Additional Sections - Only show on home page */}
...
//       {/* Health Checkup Section - Only on home page */}
//       <HealthCheckup />

//       {/* Health Articles - Only on home page */}
//       <HealthArticles />
...
import CategoryProductSection from '../components/CategoryProductSection'; // New import
...
const HomePage: React.FC = () => {
  return (
    <div className="flex flex-col gap-12 py-8">
      ...
      {/* Ensure these category names match your Supabase 'categories' table exactly */}
      <CategoryProductSection categoryName="Pain Relief" limit={4} />
      <CategoryProductSection categoryName="Vitamins" limit={4} />
      <CategoryProductSection categoryName="Antibiotics" limit={4} />
      {/* Add more CategoryProductSection components for other categories as desired */}
